...
from units import IMPERIAL_UNITS, METRIC_UNITS, UNIT_KEYS, UNIT_VALUES
...
if __name__ == "__main__":
    ...
    beam = Beam(5)
    beam.add_supports(Support(5, (1,1,1)), Support(0, (1,1,0)))
    beam.add_loads(
        PointLoad(-6000, 2.5, 90),
        DistributedLoad(1000, (0, 5), 270))
    beam.analyse()
    a = beam.plot_beam_external()
    b = beam.plot_beam_internal()
    print(beam._reactions)
